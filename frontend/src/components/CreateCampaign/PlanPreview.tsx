      ...
      <Box>
        ...
        <Stack direction="row" spacing={0.5} flexWrap="wrap" useFlexGap>
          ...
          {plan.creative_pack.headlines.length > 5 && (
            <Chip label={`+${plan.creative_pack.headlines.length - 5} more`} size="small" />
          )}
        </Stack>
      </Box>
      ...
      <Box>
        ...
        <Stack direction="row" spacing={0.5} flexWrap="wrap" useFlexGap>
          ...
          {plan.targeting_hints.keywords.length > 8 && (
            <Chip label={`+${plan.targeting_hints.keywords.length - 8} more`} size="small" />
          )}
        </Stack>
      </Box>
